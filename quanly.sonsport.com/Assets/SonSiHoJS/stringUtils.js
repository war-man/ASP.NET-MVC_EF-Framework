var stringUtils = {
    //HaiVT 26/04/2013 - convert to no VNSign
    ...
    ToShortSMSContentChar: function (strContent, numToShort) {
        if (strContent.length == 0) {
            return '';
        }
        return strContent.substring(0, numToShort);
    },
    //HaiVT 10/04/2013 - to short sms content
